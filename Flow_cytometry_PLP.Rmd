...
RequiredPackages <- c("ggplot2", "Rcpp", "vegan", "dplyr", "scales", "grid", "reshape2" ,"plyr","magrittr" ,"randomcoloR", "devtools", "remotes", "geosphere", "matrixStats" ,"data.table" ,"DT", "cowplot" , "colorspace", "PerformanceAnalytics", "corrplot", "Hmisc", "tidyverse", "readxl", "corrplot", "ggpubr", "ggalluvial", "data.table")
...
#Install phenoflow (install_github("rprops/Phenoflow_package"))
...
path = "~/GitHub/Lake_Cadagno_microbial_loop_Saini_et_al_2021/SYBR_files/"
...
metadata2$Sample_name<-str_replace_all(metadata2$Sample_name, c(" " = "." , "," = "" ))
  ...
  Flow_cytometry_names_files <- read.csv("~/GitHub/Lake_Cadagno_microbial_loop_Saini_et_al_2021/SYBR_files/Flow_cytometry_names_files.csv")
